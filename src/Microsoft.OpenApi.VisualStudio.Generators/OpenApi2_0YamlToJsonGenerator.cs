...
namespace Microsoft.OpenApi.VisualStudio.Generators
{
    ...
    [CodeGeneratorRegistration(typeof(OpenApi2_0YamlToJsonGenerator),"C# OpenAPI 2.0 YAML to JSON Generator",vsContextGuids.vsContextGuidVCSProject, GeneratesDesignTimeSource=true)]
    [CodeGeneratorRegistration(typeof(OpenApi2_0YamlToJsonGenerator), "C# OpenAPI 2.0 YAML to JSON Generator", vsContextGuids.vsContextGuidVBProject, GeneratesDesignTimeSource = true)]
