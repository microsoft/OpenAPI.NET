...
namespace Microsoft.OpenApi.VisualStudio.Generators
{
    ...
    [CodeGeneratorRegistration(typeof(OpenApi3_0YamlToJsonGenerator),"C# OpenAPI 3.0 YAML to JSON Generator",vsContextGuids.vsContextGuidVCSProject, GeneratesDesignTimeSource=true)]
    [CodeGeneratorRegistration(typeof(OpenApi3_0YamlToJsonGenerator), "C# OpenAPI 3.0 YAML to JSON Generator", vsContextGuids.vsContextGuidVBProject, GeneratesDesignTimeSource = true)]
