...
namespace Microsoft.OpenApi.VisualStudio.Generators
{
    ...
    [CodeGeneratorRegistration(typeof(OpenApi2_0JsonToYamlGenerator),"C# OpenAPI 2.0 JSON to YAML Generator",vsContextGuids.vsContextGuidVCSProject, GeneratesDesignTimeSource=true)]
    [CodeGeneratorRegistration(typeof(OpenApi2_0JsonToYamlGenerator), "C# OpenAPI 2.0 JSON to YAML Generator", vsContextGuids.vsContextGuidVBProject, GeneratesDesignTimeSource = true)]
