...
public interface IOpenApiSchema : IOpenApiDescribedElement, IOpenApiReadOnlyExtensible, IShallowCopyable<IOpenApiSchema>, IOpenApiReferenceable
{
    ...
    /// </summary>
    public OrderedDictionary<string, bool>? Vocabulary { get; }
    ...
    /// </summary>
    public OrderedDictionary<string, IOpenApiSchema>? Definitions { get; }
    ...
    /// </summary>
    public OrderedDictionary<string, IOpenApiSchema>? Properties { get; }
    ...
    /// </summary>
    public OrderedDictionary<string, IOpenApiSchema>? PatternProperties { get; }
    ...
    /// </summary>
    public OrderedDictionary<string, JsonNode>? UnrecognizedKeywords { get; }

    /// <summary>
    /// Follow JSON Schema definition:https://json-schema.org/draft/2020-12/json-schema-validation#section-6.5.4
    /// </summary>
    public OrderedDictionary<string, HashSet<string>>? DependentRequired { get; }
}
