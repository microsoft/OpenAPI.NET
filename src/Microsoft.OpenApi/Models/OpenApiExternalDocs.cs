...
namespace Microsoft.OpenApi.Models
{
    ...
    public class OpenApiExternalDocs : IOpenApiSerializable, IOpenApiExtensible
    {
        ...
        /// <summary>
        /// Parses a local file path or Url into an OpenApiExternalDocs object.
        /// </summary>
        ...
        /// <returns></returns>
        public static OpenApiExternalDocs Load(string url, OpenApiSpecVersion version, out OpenApiDiagnostic diagnostic, OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiExternalDocs>(url, version, out diagnostic, settings);
        }

        /// <summary>
        /// Reads the stream input and parses it into an OpenApiExternalDocs object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiExternalDocs Load(Stream stream,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiExternalDocs>(stream, version, out diagnostic, format, settings);
        }

        /// <summary>
        /// Reads the text reader content and parses it into an OpenApiExternalDocs object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiExternalDocs Load(TextReader input,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiExternalDocs>(input, version, out diagnostic, format, settings);
        }


        /// <summary>
        /// Parses a string into a <see cref="OpenApiExternalDocs"/> object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiExternalDocs Parse(string input,
                                            OpenApiSpecVersion version,
                                            out OpenApiDiagnostic diagnostic,
                                            string format = null,
                                            OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Parse<OpenApiExternalDocs>(input, version, out diagnostic, format, settings);
        }
    }
}
