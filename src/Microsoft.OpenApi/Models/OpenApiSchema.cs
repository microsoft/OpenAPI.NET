...
namespace Microsoft.OpenApi.Models
{
    ...
    public class OpenApiSchema : IOpenApiSerializable, IOpenApiReferenceable, IEffective<OpenApiSchema>, IOpenApiExtensible
    {
        ...
        /// <summary>
        /// Serialize <see cref="OpenApiSchema"/> to Open Api v3.1
        /// </summary>
            ...
            Action<IOpenApiWriter, IOpenApiSerializable> callback)
        {
            ...
            // default
            writer.WriteOptionalObject(OpenApiConstants.Default, (IOpenApiElement)Default, (w, d) => w.WriteAny((JsonNode)d));
