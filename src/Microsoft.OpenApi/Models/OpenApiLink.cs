...
namespace Microsoft.OpenApi.Models
{
    ...
    public class OpenApiLink : IOpenApiReferenceable, IOpenApiExtensible, IEffective<OpenApiLink>
    {
        ...
        /// <summary>
        /// Parses a local file path or Url into an OpenApiLink object.
        /// </summary>
        ...
        /// <returns></returns>
        public static OpenApiLink Load(string url, OpenApiSpecVersion version, out OpenApiDiagnostic diagnostic, OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiLink>(url, version, out diagnostic, settings);
        }

        /// <summary>
        /// Reads the stream input and parses it into an OpenApiLink object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiLink Load(Stream stream,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiLink>(stream, version, out diagnostic, format, settings);
        }

        /// <summary>
        /// Reads the text reader content and parses it into an OpenApiLink object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiLink Load(TextReader input,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiLink>(input, version, out diagnostic, format, settings);
        }


        /// <summary>
        /// Parses a string into a <see cref="OpenApiLink"/> object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiLink Parse(string input,
                                            OpenApiSpecVersion version,
                                            out OpenApiDiagnostic diagnostic,
                                            string format = null,
                                            OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Parse<OpenApiLink>(input, version, out diagnostic, format, settings);
        }
    }
}
