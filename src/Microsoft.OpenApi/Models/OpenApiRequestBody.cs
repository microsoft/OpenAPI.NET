...
namespace Microsoft.OpenApi.Models
{
    ...
    public class OpenApiRequestBody : IOpenApiReferenceable, IOpenApiExtensible, IEffective<OpenApiRequestBody>
    {
        ...
        /// <summary>
        /// Parses a local file path or Url into an OpenApiRequestBody object.
        /// </summary>
        ...
        /// <returns></returns>
        public static OpenApiRequestBody Load(string url, OpenApiSpecVersion version, out OpenApiDiagnostic diagnostic, OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiRequestBody>(url, version, out diagnostic, settings);
        }

        /// <summary>
        /// Reads the stream input and parses it into an OpenApiRequestBody object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiRequestBody Load(Stream stream,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiRequestBody>(stream, version, out diagnostic, format, settings);
        }

        /// <summary>
        /// Reads the text reader content and parses it into an OpenApiRequestBody object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiRequestBody Load(TextReader input,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiRequestBody>(input, version, out diagnostic, format, settings);
        }


        /// <summary>
        /// Parses a string into a <see cref="OpenApiRequestBody"/> object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiRequestBody Parse(string input,
                                            OpenApiSpecVersion version,
                                            out OpenApiDiagnostic diagnostic,
                                            string format = null,
                                            OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Parse<OpenApiRequestBody>(input, version, out diagnostic, format, settings);
        }
    }
}
