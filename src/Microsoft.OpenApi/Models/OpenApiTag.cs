...
namespace Microsoft.OpenApi.Models
{
    ...
    public class OpenApiTag : IOpenApiReferenceable, IOpenApiExtensible
    {
        ...
        /// <summary>
        /// Parses a local file path or Url into an OpenApiTag object.
        /// </summary>
        ...
        /// <returns></returns>
        public static OpenApiTag Load(string url, OpenApiSpecVersion version, out OpenApiDiagnostic diagnostic, OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiTag>(url, version, out diagnostic, settings);
        }

        /// <summary>
        /// Reads the stream input and parses it into an OpenApiTag object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiTag Load(Stream stream,
                                      string format,
                                      OpenApiSpecVersion version,
                                      out OpenApiDiagnostic diagnostic,
                                      OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiTag>(stream, version, out diagnostic, format, settings);
        }

        /// <summary>
        /// Reads the text reader content and parses it into an OpenApiTag object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiTag Load(TextReader input,
                                      string format,
                                      OpenApiSpecVersion version,
                                      out OpenApiDiagnostic diagnostic,
                                      OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiTag>(input, version, out diagnostic, format, settings);
        }


        /// <summary>
        /// Parses a string into a <see cref="OpenApiTag"/> object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiTag Parse(string input,
                                       OpenApiSpecVersion version,
                                       out OpenApiDiagnostic diagnostic,
                                       string format = null,
                                       OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Parse<OpenApiTag>(input, version, out diagnostic, format, settings);
        }
    }
}
