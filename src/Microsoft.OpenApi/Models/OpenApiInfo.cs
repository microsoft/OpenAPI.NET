...
namespace Microsoft.OpenApi.Models
{
    ...
    public class OpenApiInfo : IOpenApiSerializable, IOpenApiExtensible
    {
        ...
        /// <summary>
        /// Parses a local file path or Url into an OpenApiInfo object.
        /// </summary>
        ...
        /// <returns></returns>
        public static OpenApiInfo Load(string url, OpenApiSpecVersion version, out OpenApiDiagnostic diagnostic, OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiInfo>(url, version, out diagnostic, settings);
        }

        /// <summary>
        /// Reads the stream input and parses it into an OpenApiInfo object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiInfo Load(Stream stream,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiInfo>(stream, version, out diagnostic, format, settings);
        }

        /// <summary>
        /// Reads the text reader content and parses it into an OpenApiInfo object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiInfo Load(TextReader input,
                                           string format,
                                           OpenApiSpecVersion version,
                                           out OpenApiDiagnostic diagnostic,
                                           OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Load<OpenApiInfo>(input, version, out diagnostic, format, settings);
        }


        /// <summary>
        /// Parses a string into a <see cref="OpenApiInfo"/> object.
        /// </summary>
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        public static OpenApiInfo Parse(string input,
                                            OpenApiSpecVersion version,
                                            out OpenApiDiagnostic diagnostic,
                                            string format = null,
                                            OpenApiReaderSettings settings = null)
        {
            return OpenApiModelFactory.Parse<OpenApiInfo>(input, version, out diagnostic, format, settings);
        }
    }
}
