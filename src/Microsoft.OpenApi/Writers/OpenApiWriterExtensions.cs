...
namespace Microsoft.OpenApi.Writers
{
    ...
    public static class OpenApiWriterExtensions
    {
        ...
        public static void WriteRequiredMap(
            this IOpenApiWriter writer,
            string name,
            OrderedDictionary<string, string>? elements,
            Action<IOpenApiWriter, string> action)
        {
        ...
        public static void WriteOptionalMap(
            this IOpenApiWriter writer,
            string name,
            OrderedDictionary<string, JsonNode>? elements,
        ...
        public static void WriteOptionalMap(
            this IOpenApiWriter writer,
            string name,
            OrderedDictionary<string, bool>? elements,
        ...
        public static void WriteOptionalMap(
            this IOpenApiWriter writer,
            string name,
            OrderedDictionary<string, HashSet<string>>? elements,
        ...
        public static void WriteOptionalMap<T>(
            this IOpenApiWriter writer,
            string name,
            OrderedDictionary<string, T>? elements,
            Action<IOpenApiWriter, T> action)
            where T : IOpenApiElement
        {
            if (elements != null && elements.Any())
