...
namespace Microsoft.OpenApi
{
    public abstract class OpenApiVisitorBase
    {
        ...
        public virtual void Visit(List<OpenApiParameter> parameters) { }
        public virtual void Visit(OpenApiParameter parameter) { }
        public virtual void Visit(OpenApiRequestBody requestBody) { }
        public virtual void Visit(IReadOnlyDictionary<string, OpenApiResponse> responses) { }
        ...
        public virtual void Visit(Dictionary<string, OpenApiExample> example) { }
        public virtual void Visit(OpenApiSchema example) { }
        public virtual void Visit(Dictionary<string, OpenApiLink> links) { }
