...
namespace Microsoft.OpenApi.Readers.Tests.V32Tests
{
    ...
    {
        private const string SampleFolderPath = "V32Tests/Samples/OpenApiSchema/";
        ...
        [Fact]
        public async Task ParseBasicV32SchemaShouldSucceed()
        {
...
";
        ...
        [Fact]
        public async Task SerializeV32SchemaWithMultipleTypesAsV3Works()
        {
            // Arrange
...
nullable: true";
        ...
        [Fact]
        public async Task SerializeV32SchemaWithMultipleTypesAsV2Works()
        {
            // Arrange
            var expected = @"type: string
x-nullable: true";
        ...
        [Fact]
        public async Task SerializeV3SchemaWithNullableAsV32Works()
        {
            // Arrange
            var expected = @"type:
  - 'null'
  - string";
        ...
        [Fact]
        public async Task SerializeV2SchemaWithNullableExtensionAsV32Works()
        {
            // Arrange
            var expected = @"type:
  - 'null'
...
";
            var schema = OpenApiModelFactory.Parse<OpenApiSchema>(input, OpenApiSpecVersion.OpenApi3_2, new(), out _, "json");
  ...
  ""example"": ""3.24""
        ...
        // UnevaluatedProperties deserialization tests for V3.2
        [Fact]
