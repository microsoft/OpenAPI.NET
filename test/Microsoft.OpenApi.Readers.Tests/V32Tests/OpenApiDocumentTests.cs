...
namespace Microsoft.OpenApi.Readers.Tests.V32Tests
{
    public class OpenApiDocumentTests
    {
        ...
        {
            // Arrange && Act
            var actual = await OpenApiDocument.LoadAsync("V32Tests/Samples/OpenApiDocument/documentWithReusablePaths.yaml", SettingsFixture.ReaderSettings);
  ...
  properties:
    ...
    prop3:
      type: string";
            ...
            var actualMediaType = await mediaType.SerializeAsYamlAsync(OpenApiSpecVersion.OpenApi3_2);
