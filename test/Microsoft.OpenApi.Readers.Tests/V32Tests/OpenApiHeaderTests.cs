...
namespace Microsoft.OpenApi.Readers.Tests.V32Tests
{
    ...
    {
        private const string SampleFolderPath = "V32Tests/Samples/OpenApiHeader/";
        ...
        public async Task ParseBasicHeaderShouldSucceed()
        {
            ...
            // Act
            var header = await OpenApiModelFactory.LoadAsync<OpenApiHeader>(stream, OpenApiSpecVersion.OpenApi3_2, new(), settings: SettingsFixture.ReaderSettings, token: TestContext.Current.CancellationToken);
