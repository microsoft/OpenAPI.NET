...
namespace Microsoft.OpenApi.Readers.Tests.V3Tests
{
    ...
    public class OpenApiCallbackTests
    {
        ...
        {
            // Act
            var callback = await OpenApiModelFactory.LoadAsync<OpenApiCallback>(Path.Join(SampleFolderPath, "basicCallback.yaml"), OpenApiSpecVersion.OpenApi3_0, new(), SettingsFixture.ReaderSettings, token: TestContext.Current.CancellationToken);
