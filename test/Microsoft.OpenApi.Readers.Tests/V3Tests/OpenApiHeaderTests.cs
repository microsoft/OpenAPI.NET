...
namespace Microsoft.OpenApi.Readers.Tests.V3Tests
{
    ...
    public class OpenApiHeaderTests
    {
        ...
        public async Task ParseBasicHeaderShouldSucceed()
        {
            ...
            // Act
            var header = await OpenApiModelFactory.LoadAsync<OpenApiHeader>(stream, OpenApiSpecVersion.OpenApi3_0, new(), settings: SettingsFixture.ReaderSettings, token: TestContext.Current.CancellationToken);
