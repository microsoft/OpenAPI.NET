...
namespace Microsoft.OpenApi.Tests.Visitors
{
    public class InheritanceTests
    {
        ...
        public void ExpectedVirtualsInvolved()
        {
            ...
            visitor.Visit(default(List<OpenApiServer>));
            ...
            visitor.Visit(default(OrderedDictionary<HttpMethod, OpenApiOperation>));
            visitor.Visit(default(OpenApiOperation));
            visitor.Visit(default(List<IOpenApiParameter>));
            visitor.Visit(default(IOpenApiParameter));
            visitor.Visit(default(IOpenApiRequestBody));
            visitor.Visit(default(OrderedDictionary<string, IOpenApiHeader>));
            visitor.Visit(default(OrderedDictionary<string, IOpenApiCallback>));
            visitor.Visit(default(IOpenApiResponse));
            visitor.Visit(default(OpenApiResponses));
            visitor.Visit(default(OrderedDictionary<string, OpenApiMediaType>));
            visitor.Visit(default(OpenApiMediaType));
            visitor.Visit(default(OpenApiEncoding));
            visitor.Visit(default(OrderedDictionary<string, IOpenApiExample>));
            visitor.Visit(default(OpenApiComponents));
            visitor.Visit(default(OpenApiExternalDocs));
            visitor.Visit(default(IOpenApiSchema));
            visitor.Visit(default(OrderedDictionary<string, IOpenApiLink>));
            ...
            visitor.Visit(default(HashSet<OpenApiTag>));
            visitor.Visit(default(List<OpenApiSecurityRequirement>));
            visitor.Visit(default(IOpenApiExtensible));
            visitor.Visit(default(IOpenApiExtension));
            visitor.Visit(default(List<IOpenApiExample>));
            visitor.Visit(default(OrderedDictionary<string, OpenApiServerVariable>));
            visitor.Visit(default(OrderedDictionary<string, OpenApiEncoding>));
        ...
        internal protected class TestVisitor : OpenApiVisitorBase
        {
            ...
            public override void Visit(OrderedDictionary<HttpMethod, OpenApiOperation> operations)
            {
                EncodeCall();
            ...
            public override void Visit(OrderedDictionary<string, IOpenApiCallback> callbacks)
            {
                EncodeCall();
            ...
            public override void Visit(OrderedDictionary<string, IOpenApiExample> examples)
            {
                EncodeCall();
                base.Visit(examples);
            }
            ...
            public override void Visit(OrderedDictionary<string, IOpenApiLink> links)
            {
                EncodeCall();
                base.Visit(links);
            }
            ...
            public override void Visit(List<IOpenApiExample> example)
            {
                EncodeCall();
                base.Visit(example);
            }

            public override void Visit(OrderedDictionary<string, OpenApiServerVariable> serverVariables)
            {
                EncodeCall();
                base.Visit(serverVariables);
            }

            public override void Visit(OrderedDictionary<string, OpenApiEncoding> encodings)
            {
                EncodeCall();
