...
namespace Microsoft.OpenApi.Tests.Models
{
    ...
    public class OpenApiOAuthFlowsTests
    {
        ...
        public async Task SerializeOAuthFlowsWithDeviceAuthorizationAsV32JsonWorks()
        {
            ...
            // Act
            var actual = await OAuthFlowsWithDeviceAuthorization.SerializeAsJsonAsync(OpenApiSpecVersion.OpenApi3_2, TestContext.Current.CancellationToken);
        ...
        public async Task SerializeOAuthFlowsWithDeviceAuthorizationAsV31JsonWorks()
        {
            ...
            // Act
            var actual = await OAuthFlowsWithDeviceAuthorization.SerializeAsJsonAsync(OpenApiSpecVersion.OpenApi3_1, TestContext.Current.CancellationToken);
        ...
        public async Task SerializeOAuthFlowsWithDeviceAuthorizationAsV3JsonWorks()
        {
            ...
            // Act
            var actual = await OAuthFlowsWithDeviceAuthorization.SerializeAsJsonAsync(OpenApiSpecVersion.OpenApi3_0, TestContext.Current.CancellationToken);
